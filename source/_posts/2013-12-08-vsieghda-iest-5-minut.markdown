...
Начать сразу с [таких](https://github.com/errbit/errbit/issues/614) высот тяжело. Я считаю, что очень хорошо вливаться
...
Ежедневный коммит снижает уровень напряженности при посылке pr в крупные
проекты. Моя прошлая неделя выглядела так:

![неделя активности](http://puu.sh/5GgrI.png)

Уже больше 60 дней (с перерывом в одни сутки) я занимаюсь open source.
